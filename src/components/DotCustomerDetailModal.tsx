...
function calculateCustomerProductDataAllPeriods(dotData: AlpineSalesRecord[], customerName: string, viewMode: 'month' | 'quarter' = 'month') {
  const customerRecords = dotData.filter(record => record.customerName === customerName);
...
interface DotCustomerDetailModalProps {
  customerName: string;
...
const DotCustomerDetailModal: React.FC<DotCustomerDetailModalProps> = ({
  customerName,
  dotData,
  isOpen,
  onClose,
  ...
  const { products } = calculateCustomerProductDataAllPeriods(dotData, customerName, viewMode);
...
export default DotCustomerDetailModal;
